...
<nav class="<?php echo $b->getBlockValue('navc') ?> <?php echo $b->getBlockValue('navcc') ?>" style="widows: 100%;">
...
<div class="col s12 m4">
<div class="card-panel">
<h5 class="card-title">Navbar Color</h5>
<p>Change the Navigation Bar (top) color by selecting a new color below.  Advice: Your navbar color should be the same as your footer color!  Do not go crazy with too many colors
or your visitors will get turned off (this color will override the theme color selected in the Blocks screen).</p>
<p>
<label>
<input type="checkbox" name="use_navbar_color" id="use_navbar_color" value="1" <?php if($st['use_navbar_color'] == 1) { echo 'checked="checked"';} ?> onclick="updateStyle(this.id, this.checked)" />
<span>Use this color instead of theme color.</span>
</label>
</p>
<div class="row">
<span class="helper-text">Choose the Navbar Color</span>
<div class="input-field col s10">
<input type="color" name="navbar_color" id="navbar_color" value="<?php echo $st['navbar_color'] ?>" onblur="updateStyle(this.id, this.value)" />
</div>
</div>
</div>
</div>
