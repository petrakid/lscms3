...
<div class="space"></div>
<div class="row show_cascade" style="display: none;">
...
<div class="space"></div>
<div class="row show_fullWidth" style="display: none;">
<div class="col s12">
...
<div class="space"></div>
<span class="helper-text">Slide Wrapping</span>
<p>
<input type="radio" name="c_noWrap" id="c_noWrap1" value="1" <?php if($st['c_noWrap'] == 1) { echo 'checked="checked"'; } ?> onchange="changeCSValue('c_noWrap', this.value)" />
<label for="c_noWrap1">Wrap to Beginning</label>
</p>
<p>
<input type="radio" name="c_noWrap" id="c_noWrap0" value="0" <?php if($st['c_noWrap'] == 0) { echo 'checked="checked"'; } ?> onchange="changeCSValue('c_noWrap', this.value)" />
<label for="c_noWrap0">Stop after Last</label>
</p>
</div>
</div>
</div>
