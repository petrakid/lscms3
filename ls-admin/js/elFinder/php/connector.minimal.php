...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '../../../content/assets/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/content/assets', // URL to files (REQUIRED)
		...
		array(
			'id'            => '1',
			'driver'        => 'Trash',
			'path'          => '../../../content/assets/.trash/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/content/assets/.trash/.tmb/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
