...
<div id="header">
    ...
    <img onclick="reloadImages();" src="img/cd-icon-refresh.png" class="headerIconRight iconHover" title="Refresh Browser" />
    <img onclick="uploadImg();" src="img/cd-icon-upload-grey.png" class="headerIconCenter iconHover" title="Upload File" />
    <?php if($show_settings): ?>
    <img onclick="pluginSettings();" src="img/cd-icon-settings.png" class="headerIconRight iconHover" title="Settings" />
    <?php endif; ?>
</div>
